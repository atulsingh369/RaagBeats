  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <div className="px-5 mx-auto flex lg:flex-row flex-col lg:gap-0 gap-10 justify-between items-center rounded-box text-secondary lg:bg-white lg:w-3/4">
            {/* User */}
            <div className="relative flex flex-col items-center lg:w-1/2 w-full bg-white rounded-box pb-5">
              ...
              <div className="flex lg:flex-row flex-col lg:gap-0 gap-6 justify-evenly items-center w-full">
                <button
                  ...
                  className="p-2 text-xl rounded-box font-semibold border-4 border-icons">
                  Favourites
                </button>
                <button
                  onClick={() => {
